...
public class DANI extends PApplet {
	...
	String[] data = {"i", "love", "star", "trek", "tu", "dublin"};
	/*String[] expData = {"The Project Gutenberg eBook of The Sonnets, by William Shakespeare",
	...
	* You comply with all other terms of this agreement for free
    ...
    public String[] writeSonnet()
    {
		...
		while(i < Integer.MAX_VALUE){
			int r = (int)random(0, data.length-1);
			text(data[r], CENTER, CENTER);
			i++;
		}
        return null;
    }
